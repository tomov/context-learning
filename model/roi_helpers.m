...
%
filename = 'striatum.nii'; % where to save the mask 
...
roi_idxs = [];
my_idxs = [];
for i = 1:length(xml.atlas.data.label)
    name = xml.atlas.data.label{i}.name.Text;
    idx = str2num(xml.atlas.data.label{i}.index.Text);
