...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.82.01), Thu Sep 15 14:16:13 2016
...
trials = data.TrialHandler(nReps=1, method='random', 
    ...
    trialList=data.importConditions('irrelevant.xlsx', selection='range(1,5)'),
...
for thisTrial in trials:
    ...
    foodImg.setImage('foods/' + food + '.png')
